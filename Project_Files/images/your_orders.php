										...
										<tbody>
											...
											if (!mysqli_num_rows($query_res) > 0) {
												...
												<tr>
													...
													<td colspan="1">
														<?php
														$res_p = mysqli_query($db, "select * from users_orders where u_id='" . $_SESSION['user_id'] . "'");
														$price_tot = 0;
													
														while ($row = mysqli_fetch_array($res_p)) {
															$price_tot = $price_tot + $row["quantity"];
													...
													<td colspan="4">
														<?php
														$res_q = mysqli_query($db, "select * from users_orders where u_id='" . $_SESSION['user_id'] . "'");
														$price_tot = 0;
													
														while ($row = mysqli_fetch_array($res_q)) {
															$price_tot = $price_tot + $row["price"];
